...
All results reported are the median of 51 runs, and for small $$n$$. The performance tests are run on an Intel Core i7-4600U @2.1GHz. I report results both from MSVC compiler and g++/mingw. The <code>circular</code> data structure used in the tests are a slightly adapted <code>boost::circular_buffer_space_optimized</code>. 
